...
<CardGroup cols={2}>
  ...
  <Card title="mzizi-registry" icon="library" href="https://github.com/mzizi-dev/mzizi-registry">
    **The component registry, brand system and developer portal.** A Next.js app serving
    `mzizi.dev` and the `/api/v1` surface from `registry.json` and the component files beside
    it. 575 registry items, the Seven African Minerals palette, the DNA-helix architecture
    model.
